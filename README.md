...
<p align="center">
  ...
  <i> MAE from upsampling the spatial resolution of flows using FNO and bicubic interpolation separately. The FNO performs better than bicubic interpolation at every resolution that was tested.</i>
</p>
